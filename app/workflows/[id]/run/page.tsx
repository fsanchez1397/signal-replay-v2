...
import { Play, Pause, SkipForward, Square, AlertCircle, CheckCircle } from 'lucide-react';
                  ...
                  logs.map((log, index) => (
                    ...
                    >
                      <div className="flex items-start gap-2">
                        {log.level === 'error' && <AlertCircle className="w-5 h-5 mt-0.5" />}
                        {log.level === 'success' && <CheckCircle className="w-5 h-5 mt-0.5" />}
